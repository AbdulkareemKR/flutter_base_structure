...
class CustomButton extends StatefulWidget {
  ...
  ///
  : assert(!(style != null && color != null) && !(size != null && (width != null || height != null))),
        super(key: key);
...
class _CustomButtonState extends State<CustomButton> {
  ...
  Border _getBorderFromStyle() {
    switch (widget.style) {
      case CustomButtonStyle.thirdly:
        return Border.all(color: ColorsConst.cosmicCobalt, width: 1, style: BorderStyle.solid);
              ...
              child: ConditionaryWidget(
                ...
                trueWidget: SingleChildScrollView(
                  ...
                  child: SizedBox(
                    ...
                    child: Row(
                        mainAxisAlignment: _showIcon ? MainAxisAlignment.spaceBetween : MainAxisAlignment.center,
                        ...
                        children: [
                          ConditionaryWidget(
                              ...
                              trueWidget: Container(
                                ...
                                height: 35.h,
                                decoration: BoxDecoration(
                                    color: _iconBackgroundColor, borderRadius: BorderRadius.circular(9.w)),
                              )),
                          Center(
                            child: ConditionaryWidget(
                ...
                falseWidget: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  SizedBox(
                    width: _height - 20,
                    height: _height - 20,
