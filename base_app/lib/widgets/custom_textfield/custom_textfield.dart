...
class CustomTextField extends StatefulWidget {
  const CustomTextField({
    Key? key,
    required this.type,
    this.textFieldStyle = const TextStyle(color: Colors.black, fontFamily: dinNext, fontWeight: FontWeight.w200),
      ...
      children: [
        ...
        errorMessage != null
            ? Padding(
                ...
                child: Text(
                  errorMessage ?? '',
                  style: const TextStyle(color: ColorsConst.negativeRed, fontSize: 15, fontFamily: dinNext),
                ),
              )
            : const SizedBox.shrink()
      ],
