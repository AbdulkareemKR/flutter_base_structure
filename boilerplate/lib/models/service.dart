...
import 'package:garage_client/models/price_range.dart';
...
export 'package:garage_client/models/price_range.dart';
...
class Service {
  ...
  factory Service.fromMap(Map<String, dynamic> map) {
    return Service(
      ...
      logo: map['logo'] is Map<String, Map> ? CloudImage.fromJson(map['logo'] as Map<String, dynamic>) : null,
