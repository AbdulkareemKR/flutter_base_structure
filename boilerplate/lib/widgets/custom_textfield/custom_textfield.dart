...
import 'package:garage_client/widgets/custom_textfield/controller.dart';
...
class CustomTextField extends StatefulWidget {
  const CustomTextField({
    Key? key,
    required this.type,
    this.textFieldStyle = const TextStyle(color: Colors.black, fontWeight: FontWeight.w200),
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: widget.isEnabled ? ColorsConst.cultured : ColorsConst.disableGrey,
        ...
        errorMessage != null
            ? Padding(
                ...
                child: Text(
                  errorMessage ?? '',
                  style: const TextStyle(color: ColorsConst.negativeRed, fontSize: 15),
                ),
              )
            : const SizedBox.shrink()
      ],
